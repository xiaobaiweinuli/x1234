...
data class RepoDetailState(
    ...
    // 本地存储的自定义订阅偏好（位标志）
    val customNotifyIssues: Boolean = true,
    val customNotifyPRs: Boolean = true,
    val customNotifyReleases: Boolean = true,
    val customNotifyDiscussions: Boolean = false,
    val customNotifySecurity: Boolean = true,
    // Issue Templates
